  ...
  <div class="survey-flow-list">
    <div class="survey-flow-list__item">
      ...
      <div class="survey-flow-list__step">
        ...
        <p class="survey-flow-list__text">
          ご相談の第一歩はお問い合わせから始まります。<br class="u-md">
          どんなに些細なお悩みでも構いません。1人で悩まずに、そしてより大きな問題となる前に一度私達オーウェルにご相談ください。<br class="u-md">
          ご相談やお見積もりはお電話またはメールにて全国どこからでも24時間年中無休で随時受け付けています。
        </p>
      </div>
    </div>
    <div class="survey-flow-list__item">
      ...
      <div class="survey-flow-list__step">
        ...
        <p class="survey-flow-list__text">
          お客様のご都合に合わせ、弊社にご来店頂くか、弊社の相談員がお客様のご指定されたファミリーレストランや喫茶店、ご自宅などにお伺いします。出張面談につきましてもご相談は全て無料でお受け致します。<br class="u-md">
          依頼者様が、どのような事でお悩みになり、どのような事をお知りになりたいのか、調査対象者と依頼者様のご関係や最終的な調査の目的はどのような事になるのか、詳しく状況をお伺いしながら、弊社の相談員が親身にお客様のご相談を伺い的確なアドバイスとコンサルティングを行いますので、初めての方でも安心してご相談いただけます。<br class="u-md">
          実際にお伺いする相談員は各お客様のご依頼内容に応じて、その道の知識・経験が豊富な相談員が対応致します。
        </p>
      </div>
    </div>
    <div class="survey-flow-list__item">
      ...
      <div class="survey-flow-list__step">
        ...
        <p class="survey-flow-list__text">
          面談にて具体的な打ち合わせを行い、調査方法、調査料金などをご提示させて頂き、お客様の判断の元、ご契約へと移らせて頂きます。<br class="u-md">
          お見積もりの際にご提示させて頂く料金以外に追加料金を頂くことは一切ございません。<br class="u-md">
          ご不明点などはそのままにせず、ご納得のいくまでご質問下さい。<br class="u-md">
          また、契約の強要など弊社では一切行いませんのでご安心下さい。
        </p>
      </div>
    </div>
    <div class="survey-flow-list__item">
    ...
    <div class="survey-flow-list__item">
      ...
      <div class="survey-flow-list__step">
        ...
        <p class="survey-flow-list__text">
          調査終了後、再度依頼者様とお会いして調査結果を報告致します。私達オーウェルは調査結果報告がある意味でのスタートラインだと考えております。ご依頼の中には調査結果報告の段階で依頼者様のお悩みが解決されるケースもありますが、ほとんどの場合は解決の為の証拠収集や情報収集となります。<br class="u-md">
          その調査結果を元に依頼者様がどのように解決へとアプローチしていくのか、アドバイスは勿論、弁護士の紹介や、法的手段をとる際のお手伝い等、最後まで親身にお手伝いをさせて頂きます。<br class="u-md">
          もちろんアフターサービスは無料となっております。
        </p>
      </div>
    </div>
  </div>
