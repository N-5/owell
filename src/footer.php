  ...
  <div class="l-container">
    <div class="footer-sitemap">
      <div class="footer-sitemap__logo">
        <a href="<?php echo home_url(); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/common/footer-logo.png" alt="<?php bloginfo('name'); ?>"></a>
      </div>
      <div class="footer-sitemap-list">
        ...
        <div class="footer-sitemap-list__item"><a href="<?php echo home_url(); ?>/faq/">Q&amp;A</a></div>
        <div class="footer-sitemap-list__item"><a href="<?php echo home_url(); ?>/blog/">ブログ</a></div>
      </div>
    </div>
    ...
    <div class="footer-information">
      <div class="footer-information-compamy">
        <dl class="footer-information-compamy__item">
          ...
          <dd class="footer-information-compamy__content">〒920-0901<br>金沢市彦三町1-2-1 アソルティ金沢彦三</dd>
        </dl>
        <dl class="footer-information-compamy__item">
      ...
      <div class="footer-information-link">
        <h3 class="footer-information-link__heading">LINK</h3>
    ...
    <div class="footer-copyright">
      <div class="footer-copyright-contact">
        <div class="footer-copyright-contact__call"><a href="tel:0120871877"><i class="m-icon m-icon__call"><?php get_template_part('lib/call-icon'); ?></i>0120-871-877</a></div>
