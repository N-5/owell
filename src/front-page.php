...
<main id="top">
      ...
      <div class="top-reason-list">
        <div class="top-reason-list__item">
          ...
          <div class="top-reason-list__bottom">
            <p class="text">私達オーウェルは必要のない調査は徹底して排除し、各ご相談に最適な調査方法をご提案させて頂いております。</p>
          </div>
        </div>
        <div class="top-reason-list__item">
          <div class="top-reason-list__top">
        ...
        <div class="top-reason-list__item">
          ...
          <div class="top-reason-list__bottom">
            <p class="text">心理カウンセラーの資格保持者や豊富な法的知識を持つ人材との連携により業界トップレベルの調査力を誇っています。</p>
          </div>
        </div>
        <div class="top-reason-list__item">
          <div class="top-reason-list__top">
          ...
          <div class="top-reason-list__bottom">
            <p class="text">依頼主様が本当の安心を得るその時まで、追加料金は一切頂かずお手伝い、アドバイスをさせて頂きます。</p>
          </div>
        </div>
        <div class="top-reason-list__item">
          <div class="top-reason-list__top">
        ...
        <div class="top-reason-list__item">
          ...
          <div class="top-reason-list__bottom">
            <p class="text">弊社では担当弁護士や心理カウンセラーなどその道のプロとの連携を駆使し、依頼主様のお悩み解決を全力でサポート致します。</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="top-price">
    <div class="l-container">
      ...
      <div class="top-price__inner">
        <div class="top-price__fee">
          <div class="fee-heading">諸経費・手数料</div>
          <div class="fee-number"><small>¥</small>0</div>
        </div>
        <div class="top-price-menu">
          <div class="top-price-menu__item">
            <h3 class="top-price-menu__heading">相談・見積り</h3>
            <div class="top-price-menu__lead">24時間365日<span>ご相談無料</span></div>
          </div>
          <div class="top-price-menu__item">
          ...
          <div class="top-price-menu__item">
            ...
            <div class="top-price-menu__lead">お見積り時の<br class="u-sm__max">ご提案金額以外の<span>追加料金なし</span></div>
          </div>
          <div class="top-price-menu__item">
            <h3 class="top-price-menu__heading">事前調査費</h3>
            <div class="top-price-menu__lead">事前の下調べに<span>費用はなし</span></div>
          </div>
        </div>
      </div>
  ...
  <section class="top-plan">
    <div class="l-container">
      <div class="top-heading__back"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top/top-heading-plan.png" alt="plan"></div>
      <h2 class="top-heading">
        ...
        <div class="top-case-list__item">
          ...
          <div class="top-case-list__top">
            ...
            <div class="top-case-list__detail">
              ...
              <div class="text u-md">依頼者様は自分の娘の結婚相手となる人物やその親族の婚前調査を娘には言わずに依頼。特に婚約相手に不審な点がある訳ではなかったが確認の為とのこと。</div>
            </div>
          </div>
          <div class="text u-md__max">依頼者様は自分の娘の結婚相手となる人物やその親族の婚前調査を娘には言わずに依頼。特に婚約相手に不審な点がある訳ではなかったが確認の為とのこと。</div>
          <div class="top-case-list__bottom">
            <div class="top-case-list__contents">
              <div class="title">調査内容</div>
            ...
            <div class="top-case-list__price">
              <div class="title">金額</div>
              <div class="price"><small>¥</small>528,000</div>
            </div>
          </div>
        </div>
        <div class="top-case-list__item">
          ...
          <div class="top-case-list__bottom">
            <div class="top-case-list__contents">
              <div class="title">調査内容</div>
              <p class="text">依頼者様から頂いた情報から推測すると、宿泊施設を利用している可能性は極めて低いと判断。まずは各種データ調査を行い、防犯カメラの映像やATMの出金情報から滞在しているであろう地域を絞ることに成功した。その後、調査員を総動員し、聞き込み調査と捜索を行い捜索開始翌日に家電量販店で対象者と対象者の彼女の姿を発見。調査員は既に被害届を受理していた警察に連絡を入れ、対象者を保護した。</p>
            </div>
            <div class="top-case-list__price">
              <div class="title">金額</div>
  ...
  <section class="top-service">
    <div class="l-container">
      ...
      <div class="top-sercive__list">
        <div class="item">
          <div class="item-detail">
            <h3 class="m-block__title">
              <span class="jp">不倫・浮気調査</span>
  ...
  <section class="top-area">
    <div class="l-container">
      ...
      <div class="top-area-siten">
        <div class="top-area-siten__item">
          <div class="top-area__heading">七尾支店</div>
          <div class="top-area-siten__address">〒926-0021<br>石川県七尾市本府中町二 35-1</div>
        </div>
        <div class="top-area-siten__item">
          <div class="top-area__heading">富山支店</div>
          <div class="top-area-siten__address">〒930-0854<br>富山県富山市城北町21</div>
          <div class="top-area-siten__address">〒930-0854<br>富山県魚津市前新町10-7</div>
        </div>
        <div class="top-area-siten__item">
          <div class="top-area__heading">福井支店</div>
          <div class="top-area-siten__address">〒910-0006<br>福井県福井市中央2-1-15</div>
          <div class="top-area-siten__address">〒915-0061<br>福井県越前市堀川町2-14</div>
        </div>
      </div>
    </div>
  </section>
